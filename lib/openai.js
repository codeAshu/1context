...
export class OpenAIClient {
  ...
  async improvePrompt(originalPrompt, memoryContext, customInstructions = '') {
    if (!this.apiKey) {
      console.warn('OpenAI: No API key, returning original prompt');
      return originalPrompt;
    }

    const systemPrompt = this.buildSystemPrompt(memoryContext, customInstructions);
  ...
  buildSystemPrompt(memoryContext, customInstructions = '') {
